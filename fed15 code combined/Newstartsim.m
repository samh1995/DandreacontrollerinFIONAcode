...
%             [Control] = computedesiredacceleration(Control, Twist); %control.rpmshutdown is here!
            ...
            Control.desiredaccel=calculatedesacceleration(Pose, Twist,Setpoint.posn)
            [Control] = controllerfailrecovery(tStep, Pose, Twist, Control);    %turn rpm4-0 if rmpshutdown is 1   
